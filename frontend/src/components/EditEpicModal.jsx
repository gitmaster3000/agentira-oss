...
export function EditEpicModal({ epic, onClose, onSaved }) {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const updated = await api.updateEpic(epic.id, {
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center animate-fade-in p-4" onClick={onClose}>
            ...
            >
                <div className="px-6 py-4 flex items-center justify-between" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                    <h2 className="text-lg font-bold text-text-primary">Edit Epic</h2>
