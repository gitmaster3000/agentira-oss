    ...
    return (
        <aside className={`shell-sidebar${open ? ' shell-sidebar--open' : ''}`} style={{ width: '248px', flexShrink: 0, borderRight: '1px solid #30363d', background: '#161b22', display: 'flex', flexDirection: 'column', fontFamily: 'var(--font-sans)', WebkitFontSmoothing: 'antialiased' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '6px 8px' }}>
                ...
                {/* PROJECT */}
                <div style={{ padding: '16px 10px 7px', fontSize: '12.5px', fontWeight: 800, letterSpacing: '.1em', color: '#e8ebf0' }}>PROJECT</div>
                ...
                {/* BUILD */}
                <div style={{ padding: '16px 10px 7px', fontSize: '12.5px', fontWeight: 800, letterSpacing: '.1em', color: '#e8ebf0' }}>BUILD</div>
